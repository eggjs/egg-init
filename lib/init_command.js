...
module.exports = class Command {
  ...
  * processFiles(targetDir, templateDir) {
   ...
   * @return {Promise<String>} Full path of target directory
   */
  * getTargetDirectory() {
   ...
   * @return {Promise<any>} template files dir
   */
  * getTemplateDir() {
    let templateDir;
   ...
   * @return {Promise<Object>} boilerplate config mapping, `{ simple: { "name": "simple", "package": "egg-boilerplate-simple", "description": "Simple egg app boilerplate" } }`
   */
  * fetchBoilerplateMapping(pkgName) {
   ...
   * @return {Promise<String>} extract directory
   */
