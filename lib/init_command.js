...
module.exports = class Command {
  ...
  * downloadBoilerplate(pkgName) {
    ...
    yield urllib.request(tgzUrl, { streaming: true, followRedirect: true }).then(result => compressing.tgz.uncompress(result.res, saveDir));
  ...
  downloadAndUnzip(url, saveDir) {
    ...
    .then(result => compressing.tgz.uncompress(result.res, saveDir));
  }
